# Graph Report - palpitae  (2026-08-11)

## Corpus Check
- 240 files · ~196,388 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1932 nodes · 3901 edges · 152 communities (135 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 66 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d3ff825`
...
Cohesion: 0.05
Nodes (72): authRouter, body, exampleEnv, fakeEnv(), headers, httpsEnv, localhostEnv, location (+64 more)

### Community 1 - "Architecture Decision Records"
Cohesion: 0.06
Nodes (61): HMAC_SHA256, importHmacKey(), data, forgedData, base64UrlDecode(), JwtPayload, signJwt(), [, body] (+53 more)

### Community 2 - "Penalties & Scoring API"
Cohesion: 0.08
Nodes (52): KNOCKOUT_LABELS, roundLabel(), EmailError, EmailMessage, sendEmail(), body, error, error1 (+44 more)
...
Cohesion: 0.09
Nodes (43): base64UrlEncode(), buf, bytes, decoded, encoded, original, result, vectors (+35 more)
...
Cohesion: 0.09
Nodes (36): computeSelectedOutcome(), formatDate(), LockedPredictionView(), Match, MatchCard(), MatchCardProps, MatchScoreRow(), Outcome (+28 more)
...
Cohesion: 0.09
Nodes (32): body, candidate, candidates, competition_id, countResult, dbStartedAt, existing, existingSet (+24 more)
...
Cohesion: 0.12
Nodes (23): makeMatch(), match, MOCK_TIME, oneHourBefore, oneHourLater, GroupPicksResponse, li, matches (+15 more)

### Community 16 - "Events Export to R2"
Cohesion: 0.1
Nodes (27): isMatchLocked(), lockedSql(), buildBulkPutStatements(), BulkBody, BulkPrediction, byMatch, checkGroupMembership(), fetchPredictionsToImport() (+19 more)
...
Cohesion: 0.13
Nodes (20): formatDate(), PredictionItem(), PredictionItemProps, useMemberPredictions(), formatDate(), groupedByGroupName(), PredictionsModal(), PredictionsModalProps (+12 more)
...
Cohesion: 0.13
Nodes (16): dialog, fetchSpy, mockResponse(), mockTrackEvent, user, GoogleLoginButton(), GoogleLogo(), mockTrackEvent (+8 more)

### Community 21 - "Page Components & Titles"
Cohesion: 0.1
Nodes (14): CreatedGroup, CreateGroupSuccessViewProps, VisibilityFieldProps, Competition, CreatedGroup, CreateGroupModal(), CreateGroupModalProps, PRESET_LABELS (+6 more)
...
Cohesion: 0.17
Nodes (21): requireAuth, eligible, groupConfig, groupId, match, matchId, membersResult, membersStartedAt (+13 more)
...
Cohesion: 0.14
Nodes (11): RenameGroupModal(), RenameGroupModalProps, FormViewProps, JoinedGroup, JoinGroupModalProps, apiFetch(), consumeSessionExpired(), notifySessionExpired() (+3 more)
...
Cohesion: 0.2
Nodes (9): ActiveCompetition, ActiveRound, logError(), logEvent(), logRequestPerf(), RequestPerfMetrics, roundMs(), ae (+1 more)
...
## Knowledge Gaps
- **469 isolated node(s):** `body`, `setCookie`, `location`, `setCookies`, `headers` (+464 more)
...
- **What is the exact relationship between `PenaltyBadge` and `StandingsTab`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `AppContext` connect `Notifications & Observability` to `Architecture Decision Records`, `Groups Router`, `Metrics Charts & Formatters`, `Create Group Modal & Presets`, `Events Export to R2`, `Cookie Consent & GA Init`, `Google Login Button`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `trackEvent()` connect `Auth Router & Cookies` to `Rounds & Round Reminders`, `Feature Flags & Permissions`, `Auth/Groups Router Tests`, `Metrics Router`, `GA4 Analytics & Consent`, `Match Card`, `Matches Router Tests`, `Group Picks Fixtures`, `Google OAuth`, `Page Components & Titles`, `JWT Middleware`, `Fixture Discovery & Polling`, `HMAC Crypto & Tokens`, `Match Sync & API Mapping`, `Unsubscribe Router`, `Cookie Consent GA`, `Results API Script`, `App Icons & Social Card`, `Community 65`, `Community 69`, `Community 77`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `signJwt()` connect `Architecture Decision Records` to `Notifications & Observability`, `Metrics Charts & Formatters`, `Groups Router`?**

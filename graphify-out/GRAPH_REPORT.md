...
## Corpus Check
- 260 files · ~208,750 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2092 nodes · 4160 edges · 163 communities (147 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa48bab3`
...
Cohesion: 0.06
Nodes (49): AdminMetricsPage(), ArchiveQueryResponse, ArchiveResponse, ArchiveSection(), buildApiCallsSeries(), buildDauSeries(), buildStackedSeries(), BusinessResponse (+41 more)

### Community 1 - "Architecture Decision Records"
Cohesion: 0.05
Nodes (50): ConfirmModal(), ConfirmModalProps, cancelButton, confirmButton, defaultProps, ConfirmOptions, cancelButton, confirmButton (+42 more)

### Community 2 - "Penalties & Scoring API"
Cohesion: 0.05
Nodes (45): Consent, getStoredConsent(), initGa(), loadGtagScript(), setConsent(), consoleErrorSpy, getItemSpy, result (+37 more)

### Community 3 - "Rounds & Round Reminders"
Cohesion: 0.05
Nodes (50): InfoHint(), InfoHintProps, InfoSvg(), buttons, labelEl, onOpen, user, computeSelectedOutcome() (+42 more)

### Community 4 - "Feature Flags & Permissions"
Cohesion: 0.07
Nodes (51): requireAuth, getGroupMembership(), getGroupMembershipTimed(), { db, first }, { db, prepare, bind, first }, isMatchLocked(), lockedSql(), BulkBody (+43 more)
...
Cohesion: 0.07
Nodes (43): FEATURE_KEYS, FeatureFlags, FeatureKey, getFeatureFlags(), hasFeatureAccess(), edgeCaseEmails, emails, expectedFlags (+35 more)
...
Cohesion: 0.08
Nodes (20): trackEvent(), CreatedGroup, CreateGroupSuccessViewProps, VisibilityFieldProps, dialog, fetchSpy, mockResponse(), mockTrackEvent (+12 more)

### Community 9 - "Metrics Router"
Cohesion: 0.14
Nodes (32): KNOCKOUT_LABELS, roundLabel(), EmailError, EmailMessage, sendEmail(), body, error, error1 (+24 more)
...
Cohesion: 0.21
Nodes (15): authRouter, ActiveCompetition, discoverFixtures(), ActiveRound, pollActiveMatches(), EventDims, EventType, logError() (+7 more)
...
Cohesion: 0.12
Nodes (16): competitions, createdGroup, defaultProps, e, mockApiFetch, mockTrackEvent, { result }, apiFetch() (+8 more)
...
Cohesion: 0.2
Nodes (14): body, confirmationPage(), router, row, app(), authHeaders(), Captured, fakeDb() (+6 more)
...
Cohesion: 0.25
Nodes (7): HMAC_SHA256, importHmacKey(), data, forgedData, JwtPayload, forgedId, [, sig]
...
Cohesion: 0.34
Nodes (12): formatBRT(), body, buildFakeDb(), db, imgTags, MatchRow, matchSql(), out (+4 more)
...
Cohesion: 0.15
Nodes (7): AdminRadarPage(), PERIODS, RadarItem, RadarResponse, SortKey, STATUS_LABEL, Sparkline()
...
Cohesion: 0.18
Nodes (10): brasileirao, defaultBody, encerrada, filler, item(), liberta, old, semArtigo (+2 more)
...
Cohesion: 0.29
Nodes (8): base64UrlDecode(), buf, bytes, decoded, encoded, original, result, vectors
...
Cohesion: 0.36
Nodes (6): { ae, calls }, consoleSpy, err, fakeAe(), long, Point
...
Cohesion: 0.29
Nodes (5): ADR-014: Competition Radar — API-Football para oferta, Wikipedia Pageviews para demanda, Architecture Decision Records, Consequences, Context, Decision
...
## Knowledge Gaps
- **558 isolated node(s):** `data`, `forgedData`, `vectors`, `bytes`, `spy` (+553 more)
...
- **What is the exact relationship between `PenaltyBadge` and `StandingsTab`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `trackEvent()` connect `Metrics Charts & Formatters` to `Group Fetch Test Mocks`, `Architecture Decision Records`, `Penalties & Scoring API`, `Rounds & Round Reminders`, `Notifications & Observability`, `Predictions & Standings Tabs`, `Community 72`, `Community 73`, `Group Card`, `Create Group Modal & Presets`, `Match Card`, `Crypto & OAuth Helpers`, `Matches Router Tests`, `Group Picks Fixtures`, `Wrangler Config Test`, `Cookie Consent & GA Init`, `Group Card Types`, `JWT Middleware`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Router Test Helpers` to `Feature Flags & Permissions`, `Landing Page`, `Community 70`, `UI Primitives & API Cache`, `Base64 Encoding`, `Groups Router`, `Settings Page`, `API Cache Layer`, `Modal Component`, `Community 82`, `Football-data Fetch`, `Page Components & Titles`, `Auth Router & Cookies`, `App Icons & Social Card`, `HMAC Crypto & Tokens`, `Match Sync & API Mapping`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `useConfirm()` connect `Architecture Decision Records` to `Community 72`?**

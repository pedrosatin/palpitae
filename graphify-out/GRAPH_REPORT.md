# Graph Report - palpitae  (2026-06-28)

## Corpus Check
- 147 files · ~86,397 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 855 nodes · 1148 edges · 78 communities (73 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1218e04f`
...
Cohesion: 0.07
Nodes (33): EmailError, EmailMessage, sendEmail(), body, buildEmailHtml(), buildEmailText(), crestImg(), escapeHtml() (+25 more)
...
Cohesion: 0.18
Nodes (12): dayBounds(), exportEventsToR2(), exportRecentDays(), dd, env, events, FetchFake, { from, to, key } (+4 more)

### Community 15 - "Button & Header (legacy)"
Cohesion: 0.12
Nodes (16): exchangeCode(), authRouter, clearOpts, { code, state, error }, codeVerifier, cookieDomain(), cookieOptions(), KNOWN_OAUTH_ERRORS (+8 more)
...
Cohesion: 0.25
Nodes (11): ActiveCompetition, discoverFixtures(), ActiveRound, pollActiveMatches(), maybeSyncResults(), scoreUnprocessedMatches(), logEvent(), app (+3 more)
...
Cohesion: 0.19
Nodes (13): base64UrlEncode(), buildAuthUrl(), generateNonce(), generatePkce(), generateState(), GoogleIdTokenClaims, GoogleUserInfo, JwksKey (+5 more)
...
Cohesion: 0.29
Nodes (5): verifyJwt(), requireAuth, app, fakeEnv(), requestWithCookie()
...
Cohesion: 0.67
Nodes (3): fakeEnv(), requestWithCookie(), AppContext

### Community 53 - "Community 53"
Cohesion: 0.5
Nodes (3): competitions, result, router
...
## Knowledge Gaps
- **481 isolated node(s):** `PackageJson`, `Variables`, `env`, `ctx`, `app` (+476 more)
...
- **Why does `AppContext` connect `Community 52` to `Web Vite Config`, `Architecture Decision Records`, `Create Group Modal (legacy)`, `Dashboard & Group Detail Pages`, `Community 41`, `Group Card (legacy)`, `Create Group Modal`, `Button & Header (legacy)`, `Header Tests (legacy)`, `Group Detail Page Tests (legacy)`, `Community 53`, `Modal Component`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `signJwt()` connect `Architecture Decision Records` to `Community 41`, `Button & Header (legacy)`, `Group Detail Page Tests (legacy)`, `Group Detail Page (legacy)`, `Community 52`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `sendRoundReminders()` connect `API Routers & Auth Middleware` to `Header Tests (legacy)`, `Group Detail Page Tests (legacy)`?**

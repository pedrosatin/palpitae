...
## Corpus Check
- 120 files · ~63,185 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1222 nodes · 2145 edges · 82 communities (76 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `537609bb`
...
Cohesion: 0.06
Nodes (64): signJwt(), requireAuth, app, buildApp(), fakeEnv(), requestWithCookie(), fakeEnv(), requestWithCookie() (+56 more)

### Community 2 - "Auth Encoding & Google OAuth"
Cohesion: 0.05
Nodes (60): API Football (External Provider), Cloudflare D1 (SQLite), Cloudflare Pages, Cloudflare Workers, Architecture Decision Records, Auth Domain Module, Competitions Domain Module, Groups Domain Module (+52 more)
...
Cohesion: 0.09
Nodes (23): ActiveRound, pollActiveMatches(), ActiveRow, db, [earliestOver, stillRelevant], matchdays, scoreMock, syncFixturesMock (+15 more)
...
Cohesion: 0.13
Nodes (12): trackEvent(), ConfirmModalProps, Competition, CreatedGroup, CreateGroupModal(), CreateGroupModalProps, Header(), HeaderProps (+4 more)
...
## Knowledge Gaps
- **353 isolated node(s):** `app`, `{ db, updateRun }`, `syncFixturesMock`, `scoreMock`, `ActiveRow` (+348 more)
...
- **Why does `config` connect `Dashboard Page Tests (legacy)` to `API Vitest Config`, `Bracket UI Components`, `Vite Env Types`, `Create Group Modal (legacy)`, `Group Detail Page Barrel`, `Dashboard & Group Detail Pages`, `Predictions Tab Component`, `Group Card (legacy)`, `Group Card Component`, `Fixture Sync (API Football)`, `Join Group Modal`, `Modal (legacy)`, `Button Component`, `Google Login Button`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `AppContext` connect `API Routers & Auth Middleware` to `Architecture Decision Records`, `Bracket API Router`, `App Entry & Login`, `Create Group Modal`, `Card Component`?**

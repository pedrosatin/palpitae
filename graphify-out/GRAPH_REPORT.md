# Graph Report - palpitae  (2026-07-19)

## Corpus Check
- 210 files · ~175,921 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1670 nodes · 3473 edges · 129 communities (112 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1756c9ee`
...
Cohesion: 0.05
Nodes (84): requireAuth, getGroupMembership(), getGroupMembershipTimed(), matchGoesToPenalties(), parsePenaltyPhases(), cacheKey, competitionId, dbStartedAt (+76 more)

### Community 1 - "Architecture Decision Records"
Cohesion: 0.05
Nodes (76): HMAC_SHA256, importHmacKey(), base64UrlDecode(), base64UrlEncode(), buf, decoded, encoded, original (+68 more)

### Community 2 - "Penalties & Scoring API"
Cohesion: 0.06
Nodes (72): app, body, buildApp(), fakeEnv(), requestWithCookie(), body, fakeEnv(), requestWithCookie() (+64 more)

### Community 3 - "Rounds & Round Reminders"
Cohesion: 0.08
Nodes (52): ActiveCompetition, ae, buildFakeAe(), buildFakeDb(), db, errors, pointsOfType(), runs (+44 more)

### Community 4 - "Feature Flags & Permissions"
Cohesion: 0.06
Nodes (40): Consent, getStoredConsent(), initGa(), setConsent(), consoleErrorSpy, getItemSpy, result, setItemMock (+32 more)

### Community 5 - "Groups Router"
Cohesion: 0.1
Nodes (43): KNOCKOUT_LABELS, roundLabel(), EmailError, EmailMessage, sendEmail(), body, buildEmailHtml(), buildEmailText() (+35 more)
...
Cohesion: 0.09
Nodes (36): FEATURE_KEYS, FeatureFlags, FeatureKey, getFeatureFlags(), hasFeatureAccess(), flags, flags1, flags2 (+28 more)

### Community 10 - "Group Picks & Leaderboard"
Cohesion: 0.11
Nodes (29): computeSelectedOutcome(), formatDate(), LockedPredictionView(), Match, MatchCard(), MatchCardProps, MatchScoreRow(), Outcome (+21 more)
...
Cohesion: 0.11
Nodes (15): dialog, fetchSpy, mockResponse(), mockTrackEvent, user, GoogleLoginButton(), GoogleLogo(), mockTrackEvent (+7 more)
...
Cohesion: 0.14
Nodes (16): LeaderboardTab(), LeaderboardTabProps, Member, UserPrediction, formatDate(), groupedByGroupName(), PredictionsModal(), PredictionsModalProps (+8 more)
...
Cohesion: 0.22
Nodes (13): trackEvent(), DashboardPage(), DashboardPageProps, EmptyState(), GroupsList(), User, useDashboardGroups(), UseDashboardGroupsParams (+5 more)
...
Cohesion: 0.19
Nodes (12): SettingsPage(), SettingsPageProps, fetchSpy, mockResponse(), mockTrackEvent, patchCall, renderPage(), user (+4 more)
...
Cohesion: 0.23
Nodes (6): { rerender }, { unmount }, useDocumentTitle(), consumeSessionExpired(), LoginPage(), mockTrackEvent
...
Cohesion: 0.33
Nodes (11): alfa, beta, day(), finished(), leagueMatch(), makeMatch(), matches, mk() (+3 more)
...
## Knowledge Gaps
- **341 isolated node(s):** `result`, `buf`, `encoded`, `decoded`, `original` (+336 more)
...
- **What is the exact relationship between `PenaltyBadge` and `StandingsTab`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `AppContext` connect `Penalties & Scoring API` to `Notifications & Observability`, `Architecture Decision Records`, `Metrics Router`, `Match Sync & API Mapping`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `trackEvent()` connect `Group Picks Fixtures` to `Group Fetch Test Mocks`, `Match Sync Tests`, `Feature Flags & Permissions`, `Auth/Groups Router Tests`, `Metrics Charts & Formatters`, `Group Picks & Leaderboard`, `Create Group Modal & Presets`, `Match Card`, `Results API Script`, `Events Export to R2`, `Group Detail Page & Tabs`, `Page Components & Titles`, `Auth Router & Cookies`, `Fixture Discovery & Polling`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `config` connect `Match Card` to `Feature Flags & Permissions`, `Metrics Charts & Formatters`, `Group Picks & Leaderboard`, `Create Group Modal & Presets`, `Events Export to R2`, `Group Detail Page & Tabs`, `Page Components & Titles`, `Fixture Discovery & Polling`?**

...
## Corpus Check
- 190 files · ~172,021 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1486 nodes · 2697 edges · 124 communities (107 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 64 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2aebf2d4`
...
Cohesion: 0.05
Nodes (71): ActiveCompetition, discoverFixtures(), ActiveRound, pollActiveMatches(), ActiveRow, ae, buildFakeAe(), buildFakeDb() (+63 more)

### Community 1 - "Architecture Decision Records"
Cohesion: 0.05
Nodes (46): Consent, getStoredConsent(), initGa(), setConsent(), setItemMock, trackEvent(), Window, CookieConsent() (+38 more)
...
Cohesion: 0.05
Nodes (62): competitions, result, router, getGroupMembership(), getGroupMembershipTimed(), matchGoesToPenalties(), parsePenaltyPhases(), calculatePenaltyBonus() (+54 more)

### Community 4 - "Feature Flags & Permissions"
Cohesion: 0.06
Nodes (57): signJwt(), [, body], [h, , s], payload, tamperedBody, requireAuth, app, buildApp() (+49 more)

### Community 5 - "Groups Router"
Cohesion: 0.05
Nodes (52): FEATURE_KEYS, FeatureFlags, FeatureKey, getFeatureFlags(), hasFeatureAccess(), flags, flags1, flags2 (+44 more)
...
Cohesion: 0.1
Nodes (17): GroupMember, GroupPicksResponse, GroupPicksTabProps, MemberPrediction, LeaderboardTabProps, Member, UserPrediction, applyDefaultRound() (+9 more)
...
Cohesion: 0.11
Nodes (15): useConfirm(), GroupDetail, GroupDetailPage(), GroupDetailPageProps, parseTab(), Tab, TAB_LABELS, TABS (+7 more)
...
Cohesion: 0.22
Nodes (10): dialog, fetchSpy, mockResponse(), mockTrackEvent, user, JoinedGroup, JoinGroupModalProps, buildApiUrl() (+2 more)
...
Cohesion: 0.31
Nodes (11): CompetitionType, computeStandings(), emptyStanding(), FORM_GLYPHS, formatDay(), FormEntry, isLeagueTable(), RESULT_LABELS (+3 more)
...
## Knowledge Gaps
- **392 isolated node(s):** `PackageJson`, `result`, `buf`, `encoded`, `decoded` (+387 more)
...
- **What is the exact relationship between `PenaltyBadge` and `StandingsTab`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `AppContext` connect `Feature Flags & Permissions` to `Notifications & Observability`, `Penalties & Scoring API`, `Rounds & Round Reminders`, `Groups Router`, `Google OAuth`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `trackEvent()` connect `Architecture Decision Records` to `Base64 Encoding`, `Metrics Charts & Formatters`, `Group Picks & Leaderboard`, `Create Group Modal & Presets`, `Events Export to R2`, `Group Detail Page & Tabs`, `JWT Middleware`, `Governance & Domain Rules`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `signJwt()` connect `Feature Flags & Permissions` to `Penalties & Scoring API`?**

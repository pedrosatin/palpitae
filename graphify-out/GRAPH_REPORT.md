...
## Corpus Check
- 145 files · ~84,738 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 844 nodes · 1121 edges · 73 communities (69 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a98c32c`
...
Cohesion: 0.06
Nodes (36): HMAC_SHA256, importHmacKey(), JwtPayload, signJwt(), [, body], [h, , s], payload, tamperedBody (+28 more)
...
Cohesion: 0.07
Nodes (36): base64UrlDecode(), base64UrlEncode(), buf, decoded, encoded, original, result, buildAuthUrl() (+28 more)

### Community 3 - "Architecture Decision Records"
Cohesion: 0.06
Nodes (24): ConfirmModalProps, ConfirmOptions, useConfirm(), GroupDetail, GroupDetailPage(), GroupDetailPageProps, parseTab(), Tab (+16 more)
...
Cohesion: 0.09
Nodes (24): app, fakeEnv(), requestWithCookie(), fakeEnv(), requestWithCookie(), competitions, result, router (+16 more)

### Community 6 - "Predictions Tab (legacy)"
Cohesion: 0.08
Nodes (28): EmailError, EmailMessage, sendEmail(), body, buildEmailHtml(), buildEmailText(), crestImg(), escapeHtml() (+20 more)
...
Cohesion: 0.07
Nodes (26): FEATURE_KEYS, FeatureFlags, FeatureKey, getFeatureFlags(), hasFeatureAccess(), body, candidate, competition_id (+18 more)

### Community 9 - "Match Card Component"
Cohesion: 0.1
Nodes (16): Competition, CreatedGroup, CreateGroupModalProps, PRESET_LABELS, PRESET_VALUES, SCORING_HELP_TEXT, ScoringPreset, body (+8 more)
...
Cohesion: 0.12
Nodes (14): Match, Prediction, awayInput, body, fetchSpy, homeInput, input, makeMatch() (+6 more)

### Community 16 - "Join Group Modal"
Cohesion: 0.12
Nodes (13): requireAuth, cacheKey, competitionId, dbStartedAt, matchesOut, nowIso, params, response (+5 more)
...
Cohesion: 0.22
Nodes (10): DashboardPage(), DashboardPageProps, User, useDocumentTitle(), LoginPage(), SettingsPage(), SettingsPageProps, buildApiUrl() (+2 more)
...
Cohesion: 0.17
Nodes (6): dialog, fetchSpy, mockTrackEvent, user, mockTrackEvent, config
...
Cohesion: 0.2
Nodes (8): body, router, row, token, unsubscribeByToken(), userId, verifyUnsubToken(), hashUserId()

### Community 30 - "Web App Entry"
Cohesion: 0.2
Nodes (8): trackEvent(), formatDate(), MatchCard(), MatchCardProps, Member, MembersTabProps, members, mockTrackEvent
...
Cohesion: 0.33
Nodes (7): ActiveRound, pollActiveMatches(), maybeSyncResults(), scoreUnprocessedMatches(), EventDims, EventType, logEvent()
...
## Knowledge Gaps
- **478 isolated node(s):** `PackageJson`, `env`, `ctx`, `app`, `Variables` (+473 more)
...
- **Why does `AppContext` connect `Dashboard & Group Detail Pages` to `Bracket UI Components`, `Auth Encoding & Google OAuth`, `Bracket API Router`, `App Entry & Login`, `Group Card (legacy)`, `Join Group Modal`, `Pages Function Proxy`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `signJwt()` connect `Bracket UI Components` to `Auth Encoding & Google OAuth`, `Dashboard & Group Detail Pages`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `sendRoundReminders()` connect `Predictions Tab (legacy)` to `Bracket UI Components`, `Pages Function Proxy`, `Dashboard Page Barrel`, `Dashboard & Group Detail Pages`?**

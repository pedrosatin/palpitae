...
## Corpus Check
- 147 files · ~85,602 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 855 nodes · 1148 edges · 73 communities (68 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ed2958d1`
...
Cohesion: 0.06
Nodes (44): HMAC_SHA256, importHmacKey(), base64UrlDecode(), base64UrlEncode(), buf, decoded, encoded, original (+36 more)

### Community 1 - "API Routers & Auth Middleware"
Cohesion: 0.06
Nodes (30): requireAuth, app, fakeEnv(), requestWithCookie(), fakeEnv(), requestWithCookie(), body, router (+22 more)
...
Cohesion: 0.29
Nodes (11): ActiveCompetition, discoverFixtures(), ActiveRound, pollActiveMatches(), maybeSyncResults(), scoreUnprocessedMatches(), syncFixtures(), EventDims (+3 more)
...
Cohesion: 0.29
Nodes (9): competitions, result, router, matchGoesToPenalties(), parsePenaltyPhases(), calculatePenaltyBonus(), calculatePoints(), recalculateLeaderboard() (+1 more)
...
Cohesion: 0.2
Nodes (5): trackEvent(), mockTrackEvent, JoinedGroup, JoinGroupModalProps, config
...
## Knowledge Gaps
- **481 isolated node(s):** `PackageJson`, `Variables`, `app`, `env`, `ctx` (+476 more)
...
- **Why does `AppContext` connect `API Routers & Auth Middleware` to `Bracket UI Components`, `Dashboard & Group Detail Pages`, `Predictions Tab (legacy)`, `Bracket API Router`, `Fixture Sync (API Football)`, `Card Component`, `Google Login Button`?**
...
- **Why does `sendRoundReminders()` connect `Create Group Modal (legacy)` to `Bracket UI Components`, `API Routers & Auth Middleware`, `Card (legacy)`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **What connects `PackageJson`, `Variables`, `app` to the rest of the system?**

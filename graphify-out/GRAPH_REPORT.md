...
## Corpus Check
- 63 files · ~24,406 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 436 nodes · 569 edges · 35 communities (30 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be5674fa`
...
- `requestWithCookie()` --calls--> `signJwt()`  [EXTRACTED]
  api/src/auth/router.test.ts → api/src/auth/jwt.ts
...
Cohesion: 0.09
Nodes (25): requireAuth, app, fakeEnv(), requestWithCookie(), fakeEnv(), requestWithCookie(), router, competition (+17 more)
...
Cohesion: 0.19
Nodes (8): Competition, CreatedGroup, CreateGroupModalProps, GroupDetail, GroupDetailPageProps, Tab, User, config
...
Cohesion: 0.2
Nodes (4): JoinedGroup, JoinGroupModalProps, ModalProps, onClose
...
## Knowledge Gaps
- **235 isolated node(s):** `Env`, `Variables`, `app`, `ALGORITHM`, `JwtPayload` (+230 more)
...
- **Why does `config` connect `Community 11` to `Community 5`, `Community 12`, `Community 14`, `Community 16`, `Community 19`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `🤖 AGENTS.md — Palpitae` connect `Community 10` to `Community 3`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Community 2` to `Community 0`, `Community 6`?**

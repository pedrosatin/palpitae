...
## Corpus Check
- 238 files · ~193,276 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1886 nodes · 3822 edges · 137 communities (121 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 66 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bf5a3840`
...
Cohesion: 0.05
Nodes (83): HMAC_SHA256, importHmacKey(), base64UrlDecode(), base64UrlEncode(), buf, decoded, encoded, original (+75 more)

### Community 1 - "Architecture Decision Records"
Cohesion: 0.05
Nodes (79): ActiveCompetition, ae, buildFakeAe(), buildFakeDb(), db, errors, pointsOfType(), runs (+71 more)

### Community 2 - "Penalties & Scoring API"
Cohesion: 0.06
Nodes (66): isMatchLocked(), lockedSql(), matchGoesToPenalties(), parsePenaltyPhases(), createMockDb(), db, calculatePenaltyBonus(), calculatePoints() (+58 more)

### Community 3 - "Rounds & Round Reminders"
Cohesion: 0.05
Nodes (45): ConfirmModal(), ConfirmModalProps, cancelButton, confirmButton, defaultProps, ConfirmOptions, cancelButton, confirmButton (+37 more)

### Community 4 - "Feature Flags & Permissions"
Cohesion: 0.08
Nodes (48): ActiveCompetition, ActiveRound, KNOCKOUT_LABELS, roundLabel(), EmailError, EmailMessage, sendEmail(), body (+40 more)

### Community 5 - "Groups Router"
Cohesion: 0.05
Nodes (42): Consent, getStoredConsent(), initGa(), setConsent(), consoleErrorSpy, getItemSpy, result, script (+34 more)
...
Cohesion: 0.09
Nodes (28): DashboardPage(), DashboardPageProps, EmptyState(), GroupsList(), User, mockApiFetch, mockGroups, { result } (+20 more)

### Community 8 - "Metrics Charts & Formatters"
Cohesion: 0.07
Nodes (39): InfoHint(), InfoHintProps, InfoSvg(), buttons, labelEl, onOpen, user, computeSelectedOutcome() (+31 more)
...
Cohesion: 0.09
Nodes (26): formatDate(), PredictionItem(), PredictionItemProps, useMemberPredictions(), LeaderboardTab(), LeaderboardTabProps, Member, UserPrediction (+18 more)

### Community 11 - "GA4 Analytics & Consent"
Cohesion: 0.08
Nodes (20): trackEvent(), CreatedGroup, CreateGroupSuccessViewProps, VisibilityFieldProps, GoogleLoginButton(), GoogleLogo(), mockTrackEvent, GroupInviteSectionProps (+12 more)

### Community 12 - "Create Group Modal & Presets"
Cohesion: 0.08
Nodes (36): getGroupMembership(), getGroupMembershipTimed(), { db, first }, { db, prepare, bind, first }, body, candidate, candidates, competition_id (+28 more)
...
Cohesion: 0.28
Nodes (11): authRouter, discoverFixtures(), pollActiveMatches(), metricsRouter, app, scheduled(), ctx, env (+3 more)

### Community 25 - "Match Poller"
Cohesion: 0.13
Nodes (16): admin, byDay, byType, byTypeSorted, days, files, from, monthPrefixes (+8 more)
...
Cohesion: 0.18
Nodes (13): authHeaders(), bodies, body, counting, env, fetchFake, fetchOk(), files (+5 more)

### Community 34 - "Match Sync Tests"
Cohesion: 0.21
Nodes (10): GroupMember, GroupPicksResponse, GroupPicksTab(), GroupPicksTabProps, MatchPicksCard(), MemberPrediction, CacheEntry, fetchCachedJson() (+2 more)
...
Cohesion: 0.23
Nodes (6): competitions, result, router, app, competitions, AppContext
...
Cohesion: 0.33
Nodes (9): requireAuth, body, confirmationPage(), router, row, token, unsubscribeByToken(), unsubscribeFormPage() (+1 more)
...
Cohesion: 0.48
Nodes (5): app, body, buildApp(), fakeEnv(), requestWithCookie()
...
- **What is the exact relationship between `PenaltyBadge` and `StandingsTab`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `trackEvent()` connect `GA4 Analytics & Consent` to `Match Sync Tests`, `Join Group Modal`, `Rounds & Round Reminders`, `Groups Router`, `UI Primitives & API Cache`, `Auth/Groups Router Tests`, `Group Card`, `Metrics Charts & Formatters`, `Group Picks & Leaderboard`, `Events Export to R2`, `Admin Metrics Charts`, `Page Components & Titles`, `JWT Middleware`, `Fixture Discovery & Polling`, `Header Component`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `AppContext` connect `App Routing` to `Notifications & Observability`, `Architecture Decision Records`, `Penalties & Scoring API`, `Observability Events Core`, `Predictions & Standings Tabs`, `Create Group Modal & Presets`, `Results API Script`, `Crypto & OAuth Helpers`, `Google Login Button`, `Match Poller`, `Community 61`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `apiFetch()` connect `Auth/Groups Router Tests` to `Match Sync Tests`, `Join Group Modal`, `Rounds & Round Reminders`, `UI Primitives & API Cache`, `Metrics Charts & Formatters`, `Group Picks & Leaderboard`, `GA4 Analytics & Consent`, `Page Components & Titles`, `Fixture Discovery & Polling`?**

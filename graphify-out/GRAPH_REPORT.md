# Graph Report - palpitae  (2026-06-20)

## Corpus Check
- 119 files · ~63,448 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1212 nodes · 2126 edges · 78 communities (71 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `00f1faf8`
...
Cohesion: 0.05
Nodes (66): signJwt(), requireAuth, app, buildApp(), fakeEnv(), requestWithCookie(), fakeEnv(), requestWithCookie() (+58 more)

### Community 2 - "Auth Encoding & Google OAuth"
Cohesion: 0.05
Nodes (52): ActiveRound, ActiveRow, db, [earliestOver, stillRelevant], matchdays, scoreMock, syncFixturesMock, cacheKey (+44 more)
...
Cohesion: 0.09
Nodes (42): base64UrlDecode(), base64UrlEncode(), buf, decoded, encoded, original, result, buildAuthUrl() (+34 more)

### Community 5 - "Dashboard & Group Detail Pages"
Cohesion: 0.07
Nodes (47): API Football (External Provider), Cloudflare D1 (SQLite), Cloudflare Pages, Cloudflare Workers, Architecture Decision Records, Auth Domain Module, Competitions Domain Module, Groups Domain Module (+39 more)
...
Cohesion: 0.09
Nodes (13): DashboardPage(), DashboardPageProps, User, GroupDetail, GroupDetailPage(), GroupDetailPageProps, parseTab(), Tab (+5 more)
...
Cohesion: 0.1
Nodes (14): Consent, getStoredConsent(), initGa(), setConsent(), trackEvent(), Window, mockGetStoredConsent, mockSetConsent (+6 more)
...
Cohesion: 0.11
Nodes (18): 🤖 AGENTS.md — Palpitae, 📊 Analytics — GA Events (obrigatório), ⚠️ Anti-Patterns (Avoid), 🏗️ Architecture Guidelines, 🧩 Code Guidelines, code:ts (import { trackEvent } from '../../analytics/ga'), 🗄️ Database Rules, ⚽ Domain Rules (Critical) (+10 more)
...
## Knowledge Gaps
- **350 isolated node(s):** `app`, `{ db, updateRun }`, `syncFixturesMock`, `scoreMock`, `ActiveRow` (+345 more)
...
- **Why does `config` connect `Fixture Sync (API Football)` to `API Vitest Config`, `Bracket UI Components`, `Vite Env Types`, `Architecture Decision Records`, `Login Page Barrel`, `Bracket API Router`, `Predictions Tab Component`, `Group Card Component`, `Create Group Modal`, `Button & Header (legacy)`, `Community 49`, `Header Tests (legacy)`, `Modal Component`, `Button Component`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `AppContext` connect `API Routers & Auth Middleware` to `Auth Encoding & Google OAuth`, `Create Group Modal (legacy)`, `App Entry & Login`, `Match Card Component`, `Card (legacy)`?**

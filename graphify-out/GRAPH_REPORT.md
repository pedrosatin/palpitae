...
## Corpus Check
- 260 files · ~209,147 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2092 nodes · 4160 edges · 162 communities (145 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8d27540d`
...
Cohesion: 0.16
Nodes (32): roundLabel(), EmailError, EmailMessage, sendEmail(), body, error, error1, error2 (+24 more)
...
Cohesion: 0.13
Nodes (15): { rerender }, { unmount }, useDocumentTitle(), apiFetch(), consumeSessionExpired(), notifySessionExpired(), dispatchEventSpy, fetchMock (+7 more)

### Community 16 - "Events Export to R2"
Cohesion: 0.14
Nodes (18): HMAC_SHA256, importHmacKey(), data, forgedData, base64UrlDecode(), base64UrlEncode(), buf, bytes (+10 more)
...
Cohesion: 0.1
Nodes (22): ScoringRulesFieldProps, PRESET_LABELS, PRESET_VALUES, SCORING_HELP_TEXT, ScoringPreset, Competition, CreatedGroup, CreateGroupModal() (+14 more)
...
Cohesion: 0.13
Nodes (19): dialog, fetchSpy, mockResponse(), mockTrackEvent, user, fetchSpy, mockResponse(), mockTrackEvent (+11 more)
...
Cohesion: 0.18
Nodes (19): buildAuthUrl(), exchangeCode(), generateNonce(), generatePkce(), generateState(), GoogleIdTokenClaims, GoogleUserInfo, JwksKey (+11 more)
...
Cohesion: 0.13
Nodes (10): trackEvent(), CreatedGroup, CreateGroupSuccessViewProps, VisibilityFieldProps, GoogleLoginButton(), GoogleLogo(), mockTrackEvent, GroupInviteSectionProps (+2 more)
...
Cohesion: 0.36
Nodes (11): body, buildFakeDb(), db, imgTags, MatchRow, matchSql(), out, recipients (+3 more)
...
- **What is the exact relationship between `PenaltyBadge` and `StandingsTab`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `trackEvent()` connect `JWT Middleware` to `Notifications & Observability`, `Architecture Decision Records`, `Penalties & Scoring API`, `Rounds & Round Reminders`, `Create Group Modal & Presets`, `Match Card`, `Crypto & OAuth Helpers`, `API Cache Layer`, `Matches Router Tests`, `Google OAuth`, `Auth Router & Cookies`, `Match Sync Tests`, `Join Group Modal`, `App Routing`, `Admin Metrics Charts`, `Football-data Fetch`, `Community 69`, `Community 70`, `Community 78`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Cookie Consent GA` to `Observability Events Core`, `Community 66`, `Groups Router`, `UI Primitives & API Cache`, `Unsubscribe Router`, `Group Card`, `Metrics Charts & Formatters`, `Settings Page`, `Modal Component`, `Events Export to R2`, `Penalty Badge`, `Cookie Consent & GA Init`, `Group Card Types`, `Match Poller`, `Fixture Discovery & Polling`, `Match Sync & API Mapping`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `useConfirm()` connect `Notifications & Observability` to `Community 70`?**

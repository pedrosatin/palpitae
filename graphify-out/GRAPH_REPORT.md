...
## Corpus Check
- 240 files · ~196,382 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1932 nodes · 3901 edges · 151 communities (133 shown, 18 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 66 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2a8c4d29`
...
Cohesion: 0.09
Nodes (35): computeSelectedOutcome(), formatDate(), LockedPredictionView(), Match, MatchCard(), MatchCardProps, MatchScoreRow(), Outcome (+27 more)

### Community 8 - "Metrics Charts & Formatters"
Cohesion: 0.09
Nodes (28): dialog, fetchSpy, mockResponse(), mockTrackEvent, user, GoogleLoginButton(), GoogleLogo(), fetchSpy (+20 more)
...
Cohesion: 0.1
Nodes (22): GroupMember, GroupPicksResponse, GroupPicksTab(), GroupPicksTabProps, MatchPicksCard(), MemberPrediction, applyDefaultRound(), isGroupStageRound() (+14 more)

### Community 11 - "GA4 Analytics & Consent"
Cohesion: 0.09
Nodes (23): ScoringRulesFieldProps, VisibilityFieldProps, PRESET_LABELS, PRESET_VALUES, SCORING_HELP_TEXT, ScoringPreset, Competition, CreatedGroup (+15 more)
...
Cohesion: 0.1
Nodes (24): formatDate(), PredictionItem(), PredictionItemProps, useMemberPredictions(), LeaderboardTab(), LeaderboardTabProps, Member, UserPrediction (+16 more)
...
Cohesion: 0.15
Nodes (11): Consent, getStoredConsent(), initGa(), setConsent(), Window, CookieConsent(), mockGetStoredConsent, mockSetConsent (+3 more)
...
Cohesion: 0.15
Nodes (15): RenameGroupModal(), RenameGroupModalProps, apiFetch(), consumeSessionExpired(), notifySessionExpired(), dispatchEventSpy, fetchMock, setItemSpy (+7 more)

### Community 25 - "Match Poller"
Cohesion: 0.19
Nodes (9): trackEvent(), { rerender }, { unmount }, useDocumentTitle(), LoginPage(), SettingsPage(), SettingsPageProps, useNotificationPreferences() (+1 more)
...
Cohesion: 0.19
Nodes (12): ActiveCompetition, ActiveRound, EventDims, EventType, logError(), logEvent(), { ae, calls }, consoleSpy (+4 more)
...
Cohesion: 0.3
Nodes (11): BrowserFrame(), Cta(), Faq(), FaqItem(), FeatureRow(), Features(), Footer(), Header() (+3 more)
...
- **What is the exact relationship between `PenaltyBadge` and `StandingsTab`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `AppContext` connect `Notifications & Observability` to `Architecture Decision Records`, `Groups Router`, `Metrics Router`, `Match Card`, `Events Export to R2`, `Group Picks Fixtures`, `Cookie Consent & GA Init`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `trackEvent()` connect `Match Poller` to `Penalties & Scoring API`, `Rounds & Round Reminders`, `Auth/Groups Router Tests`, `Metrics Charts & Formatters`, `Group Picks & Leaderboard`, `GA4 Analytics & Consent`, `Crypto & OAuth Helpers`, `API Cache Layer`, `Page Components & Titles`, `Auth Router & Cookies`, `Google Login Button`, `HMAC Crypto & Tokens`, `Match Sync & API Mapping`, `Group Card`, `Cookie Consent GA`, `Results API Script`, `Brand Logo Variants`, `Community 64`, `Community 65`, `Community 74`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `signJwt()` connect `Architecture Decision Records` to `Notifications & Observability`, `Metrics Router`, `Groups Router`?**

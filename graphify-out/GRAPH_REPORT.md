...
## Corpus Check
- 139 files · ~70,691 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1208 nodes · 2122 edges · 89 communities (80 shown, 9 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bac8bae3`
...
Cohesion: 0.06
Nodes (51): ActiveRound, pollActiveMatches(), ActiveRow, db, [earliestOver, stillRelevant], matchdays, scoreMock, syncFixturesMock (+43 more)
...
Cohesion: 0.23
Nodes (10): requireAuth, app, buildApp(), fakeEnv(), requestWithCookie(), router, app, AppContext (+2 more)
...
Cohesion: 0.23
Nodes (5): ConfirmModalProps, Competition, CreatedGroup, CreateGroupModal(), CreateGroupModalProps
...
Cohesion: 0.38
Nodes (4): trackEvent(), Header(), HeaderProps, User
...
Cohesion: 0.47
Nodes (3): Member, MembersTab(), MembersTabProps
...
## Knowledge Gaps
- **346 isolated node(s):** `app`, `{ db, updateRun }`, `syncFixturesMock`, `scoreMock`, `ActiveRow` (+341 more)
...
- **Why does `config` connect `Card (legacy)` to `Bracket UI Components`, `API Vitest Config`, `Auth Encoding & Google OAuth`, `Web Test Setup`, `Vite Env Types`, `Dashboard Page Barrel`, `Google Login Button`, `Match Card Component`, `Predictions Tab Component`, `Community 44`, `Join Group Modal`, `Header Tests (legacy)`, `Modal Component`, `Dashboard Page Tests (legacy)`, `Button Component`, `Community 59`, `Community 62`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Group Card Component` to `API Routers & Auth Middleware`, `Architecture Decision Records`, `Predictions Tab (legacy)`, `Bracket API Router`, `App Entry & Login`, `Group Card (legacy)`, `Group Detail Page Tests (legacy)`, `Team Badge Component`?**

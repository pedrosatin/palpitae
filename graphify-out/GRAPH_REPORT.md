...
## Corpus Check
- 149 files · ~87,879 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 873 nodes · 1167 edges · 82 communities (76 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `47d491dd`
...
Cohesion: 0.05
Nodes (55): fakeEnv(), requestWithCookie(), ActiveCompetition, discoverFixtures(), ActiveRound, pollActiveMatches(), ActiveRow, ae (+47 more)
...
Cohesion: 0.32
Nodes (8): HMAC_SHA256, importHmacKey(), base64UrlEncode(), JwtPayload, signUnsubToken(), forgedId, [, sig], verifyUnsubToken()
...
## Knowledge Gaps
- **491 isolated node(s):** `PackageJson`, `Variables`, `env`, `ctx`, `app` (+486 more)
...
- **Why does `AppContext` connect `Bracket UI Components` to `API Routers & Auth Middleware`, `Vite Env Types`, `Web Test Setup`, `Create Group Modal (legacy)`, `Dashboard & Group Detail Pages`, `Predictions Tab (legacy)`, `Community 43`, `Group Card Component`, `Community 50`, `Group Detail Page Tests (legacy)`, `Modal (legacy)`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `signJwt()` connect `Group Detail Page Tests (legacy)` to `Bracket UI Components`, `Web Test Setup`, `Predictions Tab (legacy)`, `Community 43`, `Community 50`, `Modal (legacy)`, `Dashboard Page Tests (legacy)`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `sendRoundReminders()` connect `Bracket UI Components` to `Dashboard Page Tests (legacy)`, `Architecture Decision Records`?**

...
## Corpus Check
- 120 files · ~54,190 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1001 nodes · 1813 edges · 67 communities (61 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `45a6bbb2`
...
Cohesion: 0.21
Nodes (11): requireAuth, app, buildApp(), fakeEnv(), requestWithCookie(), fakeEnv(), requestWithCookie(), router (+3 more)

### Community 13 - "Fixture Sync (API Football)"
Cohesion: 0.15
Nodes (16): cacheKey, competition, competitionId, dbStartedAt, firstOpen, MatchRow, nowIso, params (+8 more)

### Community 14 - "Create Group Modal"
Cohesion: 0.11
Nodes (10): ButtonProps, onClick, HeaderProps, User, JoinedGroup, JoinGroupModalProps, GroupDetail, GroupDetailPageProps (+2 more)
...
## Knowledge Gaps
- **238 isolated node(s):** `app`, `TEAM_TRANSLATIONS`, `COMP_TRANSLATIONS`, `ApiTeam`, `ApiMatch` (+233 more)
...
- **Why does `config` connect `Card Component` to `Bracket UI Components`, `API Routers & Auth Middleware`, `Community 41`, `Predictions Tab Component`, `Create Group Modal`, `Group Detail Page (legacy)`, `Card (legacy)`, `Modal Component`, `Team Badge Component`, `Google Login Button`, `Pages Function Proxy`, `Web App Entry`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Group Card Component` to `Auth Encoding & Google OAuth`, `Dashboard & Group Detail Pages`, `Predictions Tab (legacy)`, `App Entry & Login`, `Match Card Component`, `Fixture Sync (API Football)`, `Group Detail Page Tests (legacy)`, `Button Component`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `requireAuth` connect `Group Card Component` to `Auth Encoding & Google OAuth`, `Dashboard & Group Detail Pages`, `Predictions Tab (legacy)`, `App Entry & Login`, `Fixture Sync (API Football)`?**

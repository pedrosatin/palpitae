# Graph Report - palpitae  (2026-05-25)

## Corpus Check
- 59 files · ~21,728 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 415 nodes · 541 edges · 29 communities (24 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba252951`
...
Cohesion: 0.05
Nodes (28): Competition, CreatedGroup, CreateGroupModalProps, competitions, createdGroup, defaultProps, JoinedGroup, JoinGroupModalProps (+20 more)
...
Cohesion: 0.06
Nodes (44): App Root Component, Cloudflare D1, Cloudflare Workers, Frontend Config, Runtime Context, Architecture Decision Records, Base64URL Encoding Utils, Google Login Button (+36 more)
...
- **Why does `AppContext` connect `Community 4` to `Community 1`, `Community 6`, `Community 15`?**

# Graph Report - palpitae-pr63  (2026-07-16)

## Corpus Check
- 210 files · ~176,128 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1607 nodes · 2904 edges · 147 communities (128 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `816bd15a`
...
1. `trackEvent()` - 35 edges
2. `AppContext` - 32 edges
3. `signJwt()` - 30 edges
4. `config` - 27 edges
5. `apiFetch()` - 24 edges
6. `scoreUnprocessedMatches()` - 23 edges
7. `🧠 Palpitae — Product Vision` - 23 edges
8. `syncFixtures()` - 21 edges
9. `logEvent()` - 20 edges
10. `sendRoundReminders()` - 19 edges
...
Cohesion: 0.08
Nodes (35): AdminMetricsPage(), ArchiveResponse, ArchiveSection(), buildApiCallsSeries(), buildStackedSeries(), CRON_INFO, formatAgo(), formatBytes() (+27 more)

### Community 2 - "Penalties & Scoring API"
Cohesion: 0.06
Nodes (32): CreatedGroup, CreateGroupSuccessViewProps, ScoringRulesFieldProps, VisibilityFieldProps, PRESET_LABELS, PRESET_VALUES, SCORING_HELP_TEXT, ScoringPreset (+24 more)
...
Cohesion: 0.08
Nodes (41): getGroupMembership(), getGroupMembershipTimed(), byMatch, checkGroupMembership(), eligible, groupConfig, groupId, handleBulkPut() (+33 more)
...
Cohesion: 0.07
Nodes (23): computeSelectedOutcome(), formatDate(), Match, MatchCard(), MatchCardProps, Outcome, OUTCOMES, persistPrediction() (+15 more)

### Community 8 - "Metrics Charts & Formatters"
Cohesion: 0.1
Nodes (17): GroupMember, GroupPicksResponse, GroupPicksTabProps, MemberPrediction, LeaderboardTabProps, Member, UserPrediction, groupedByGroupName() (+9 more)
...
Cohesion: 0.17
Nodes (23): EmailError, EmailMessage, sendEmail(), body, buildEmailHtml(), buildEmailText(), buildRecipientGroups(), crestImg() (+15 more)
...
Cohesion: 0.07
Nodes (26): body, candidate, candidates, competition_id, countResult, dbStartedAt, existing, existingSet (+18 more)

### Community 13 - "Match Card"
Cohesion: 0.09
Nodes (16): GroupDetail, GroupDetailPage(), GroupDetailPageProps, parseTab(), Tab, TAB_LABELS, TABS, useGroupActions() (+8 more)

### Community 14 - "Crypto & OAuth Helpers"
Cohesion: 0.15
Nodes (22): CompetitionType, computeStandings(), emptyStanding(), FORM_GLYPHS, formatDay(), FormEntry, isLeagueTable(), RESULT_LABELS (+14 more)

### Community 15 - "API Cache Layer"
Cohesion: 0.13
Nodes (22): handleGetGroups(), cacheKey, competitionId, dbStartedAt, fetchSyncNeeds(), handleGetMatches(), matchesCacheControl(), matchesOut (+14 more)

### Community 16 - "Events Export to R2"
Cohesion: 0.15
Nodes (18): requireAuth, app, buildApp(), fakeEnv(), requestWithCookie(), competitions, result, router (+10 more)

### Community 17 - "Group Detail Page & Tabs"
Cohesion: 0.19
Nodes (15): HMAC_SHA256, importHmacKey(), base64UrlDecode(), base64UrlEncode(), buf, decoded, encoded, original (+7 more)
...
Cohesion: 0.2
Nodes (18): backfillEventsMetadata(), dayBounds(), exportEventsToR2(), exportRecentDays(), dd, env, events, FetchFake (+10 more)

### Community 21 - "Page Components & Titles"
Cohesion: 0.13
Nodes (13): RenameGroupModalProps, apiFetch(), notifySessionExpired(), Member, MemberItemProps, MembersTabProps, groupedRoundMatches(), PredictionMap (+5 more)
...
Cohesion: 0.21
Nodes (12): discoverFixtures(), ActiveRound, pollActiveMatches(), EventDims, EventType, logEvent(), { ae, calls }, fakeAe() (+4 more)

### Community 24 - "Google Login Button"
Cohesion: 0.18
Nodes (19): app, body, cacheHeaderFor(), counter, createMatchesDbMock(), db, env, fakeEnv() (+11 more)

### Community 25 - "Match Poller"
Cohesion: 0.24
Nodes (16): signJwt(), fakeEnv(), requestWithCookie(), body, createDbMock(), createGroupByIdDbMock(), createGroupsListDbMock(), createRemoveMemberDbMock() (+8 more)

### Community 26 - "JWT Middleware"
Cohesion: 0.17
Nodes (11): DashboardPage(), useDashboardGroups(), UseDashboardGroupsParams, CacheEntry, fetchCachedJson(), invalidateApiCache(), responseCache, loader (+3 more)

### Community 27 - "Fixture Discovery & Polling"
Cohesion: 0.16
Nodes (17): ActiveCompetition, ApiCompetition, ApiMatch, ApiMatchesResponse, ApiTeam, buildMatchStatement(), COMP_TRANSLATIONS, mapStatus() (+9 more)
...
Cohesion: 0.21
Nodes (12): dialog, fetchSpy, mockResponse(), mockTrackEvent, user, fetchSpy, mockResponse(), mockTrackEvent (+4 more)
...
Cohesion: 0.21
Nodes (10): Consent, getStoredConsent(), setConsent(), consoleErrorSpy, getItemSpy, result, setItemMock, CookieConsent() (+2 more)
...
Cohesion: 0.34
Nodes (8): matchGoesToPenalties(), parsePenaltyPhases(), db, calculatePenaltyBonus(), calculatePoints(), recalculateLeaderboard(), scoreMatch(), scoreUnprocessedMatches()

### Community 37 - "Landing Page"
Cohesion: 0.14
Nodes (7): trackEvent(), GoogleLoginButton(), GoogleLogo(), GroupInviteSectionProps, FormViewProps, JoinedGroup, JoinGroupModalProps

### Community 38 - "Predictions & Standings Tabs"
Cohesion: 0.21
Nodes (7): DashboardPageProps, User, consumeSessionExpired(), SettingsPage(), SettingsPageProps, useNotificationPreferences(), User
...
Cohesion: 0.19
Nodes (10): ConfirmModal(), ConfirmModalProps, ConfirmOptions, cancelButton, confirmButton, TestComponent(), triggerButton, useConfirm() (+2 more)
...
Cohesion: 0.16
Nodes (5): initGa(), Window, mockTrackEvent, mockTrackEvent, rootEl
...
Cohesion: 0.27
Nodes (10): authHeaders(), bodies, body, counting, fetchFake, fetchOk(), list, makeApp() (+2 more)

### Community 48 - "Button Component"
Cohesion: 0.17
Nodes (8): ActiveCompetition, ae, db, errors, runs, scoreMock, syncFixturesMock, WrittenPoint
...
## Knowledge Gaps
- **439 isolated node(s):** `PackageJson`, `result`, `buf`, `encoded`, `decoded` (+434 more)
...
- **What is the exact relationship between `PenaltyBadge` and `StandingsTab`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `AppContext` connect `Events Export to R2` to `Community 66`, `Rounds & Round Reminders`, `Feature Flags & Permissions`, `Group Card`, `Create Group Modal & Presets`, `API Cache Layer`, `Modal Component`, `SEO Assets`, `Cookie Consent & GA Init`, `Google Login Button`, `Match Poller`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `trackEvent()` connect `Landing Page` to `Architecture Decision Records`, `Penalties & Scoring API`, `Observability Events Core`, `Match Sync Tests`, `Predictions & Standings Tabs`, `Auth/Groups Router Tests`, `Metrics Charts & Formatters`, `Settings Page`, `Results API Script`, `Crypto & OAuth Helpers`, `Match Card`, `Page Components & Titles`, `JWT Middleware`, `Community 61`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `scoreUnprocessedMatches()` connect `Base64 Encoding` to `Join Group Modal`, `Router Test Helpers`, `API Cache Layer`, `Button Component`, `Cookie Consent & GA Init`, `Fixture Discovery & Polling`?**

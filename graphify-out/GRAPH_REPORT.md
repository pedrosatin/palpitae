...
## Corpus Check
- 240 files · ~196,428 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1929 nodes · 3894 edges · 143 communities (127 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 66 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d2028683`
...
Cohesion: 0.05
Nodes (70): HMAC_SHA256, importHmacKey(), data, forgedData, base64UrlDecode(), base64UrlEncode(), buf, bytes (+62 more)

### Community 1 - "Architecture Decision Records"
Cohesion: 0.06
Nodes (59): authRouter, ActiveCompetition, discoverFixtures(), ActiveRound, pollActiveMatches(), logError(), backfillEventsMetadata(), dayBounds() (+51 more)

### Community 2 - "Penalties & Scoring API"
Cohesion: 0.06
Nodes (65): signJwt(), app, body, buildApp(), c, fakeEnv(), next, requestWithCookie() (+57 more)
...
Cohesion: 0.05
Nodes (45): Consent, getStoredConsent(), initGa(), setConsent(), consoleErrorSpy, getItemSpy, result, script (+37 more)

### Community 5 - "Groups Router"
Cohesion: 0.08
Nodes (47): AdminMetricsPage(), ArchiveQueryResponse, ArchiveResponse, ArchiveSection(), buildApiCallsSeries(), buildDauSeries(), buildStackedSeries(), BusinessResponse (+39 more)
...
Cohesion: 0.06
Nodes (33): ConfirmModal(), ConfirmModalProps, cancelButton, confirmButton, defaultProps, ConfirmOptions, cancelButton, confirmButton (+25 more)

### Community 8 - "Metrics Charts & Formatters"
Cohesion: 0.08
Nodes (47): requireAuth, isMatchLocked(), lockedSql(), BulkBody, BulkPrediction, byMatch, checkGroupMembership(), eligible (+39 more)
...
Cohesion: 0.07
Nodes (38): InfoHint(), InfoHintProps, InfoSvg(), buttons, labelEl, onOpen, user, computeSelectedOutcome() (+30 more)
...
Cohesion: 0.11
Nodes (18): GroupMember, GroupPicksResponse, GroupPicksTab(), GroupPicksTabProps, MatchPicksCard(), MemberPrediction, Member, UserPrediction (+10 more)
...
Cohesion: 0.09
Nodes (13): trackEvent(), CreatedGroup, CreateGroupSuccessViewProps, VisibilityFieldProps, GoogleLoginButton(), GoogleLogo(), mockTrackEvent, GroupInviteSectionProps (+5 more)
...
Cohesion: 0.11
Nodes (22): formatDate(), PredictionItem(), PredictionItemProps, useMemberPredictions(), LeaderboardTab(), LeaderboardTabProps, formatDate(), groupedByGroupName() (+14 more)
...
Cohesion: 0.13
Nodes (20): dialog, fetchSpy, mockResponse(), mockTrackEvent, user, AdminMetricsPage, App(), AuthStatus (+12 more)
...
Cohesion: 0.24
Nodes (5): competitions, result, router, app, competitions
...
Cohesion: 0.53
Nodes (5): useMatchCard(), UseMatchCardProps, useMatchDraft(), useMatchPersistence(), useMatchStatus()
...
## Knowledge Gaps
- **468 isolated node(s):** `body`, `setCookie`, `location`, `setCookies`, `headers` (+463 more)
...
- **What is the exact relationship between `PenaltyBadge` and `StandingsTab`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `trackEvent()` connect `Group Detail Page & Tabs` to `Observability Events Core`, `Feature Flags & Permissions`, `Groups Router`, `Auth/Groups Router Tests`, `Settings Page`, `Group Picks & Leaderboard`, `Create Group Modal & Presets`, `Match Card`, `Crypto & OAuth Helpers`, `API Cache Layer`, `Community 80`, `Google OAuth`, `Wrangler Config Test`, `Cookie Consent & GA Init`, `Google Login Button`, `Header Component`, `Community 62`, `Community 63`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Penalties & Scoring API` to `Notifications & Observability`, `Architecture Decision Records`, `UI Primitives & API Cache`, `Metrics Charts & Formatters`, `Button Component`, `Events Export to R2`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `signJwt()` connect `Penalties & Scoring API` to `Notifications & Observability`, `Architecture Decision Records`?**

...
## Corpus Check
- 155 files · ~88,436 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 982 nodes · 2012 edges · 75 communities (72 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `21c98cf2`
...
- `applyDefaultRound()` --calls--> `setRoundIndex`  [INFERRED]
  /home/satin/Work/personal/palpitae/web/src/lib/rounds.ts → /home/satin/Work/personal/palpitae/web/src/lib/rounds.test.ts
- `scheduled()` --calls--> `sendRoundReminders()`  [EXTRACTED]
  /home/satin/Work/personal/palpitae/api/src/index.ts → /home/satin/Work/personal/palpitae/api/src/notifications/roundReminder.ts
...
Cohesion: 0.05
Nodes (68): competitions, result, router, matchGoesToPenalties(), parsePenaltyPhases(), cacheKey, competitionId, dbStartedAt (+60 more)

### Community 2 - "Auth Encoding & Google OAuth"
Cohesion: 0.07
Nodes (56): ActiveCompetition, discoverFixtures(), ActiveRound, pollActiveMatches(), ActiveRow, ae, buildFakeAe(), buildFakeDb() (+48 more)

### Community 3 - "Architecture Decision Records"
Cohesion: 0.06
Nodes (41): makeMatch(), GroupMember, GroupPicksResponse, GroupPicksTab(), GroupPicksTabProps, MemberPrediction, GroupPicksResponse, li (+33 more)
...
Cohesion: 0.11
Nodes (30): FEATURE_KEYS, FeatureFlags, FeatureKey, getFeatureFlags(), hasFeatureAccess(), flags, flags1, flags2 (+22 more)

### Community 8 - "App Entry & Login"
Cohesion: 0.1
Nodes (23): ConfirmModal(), ConfirmModalProps, ConfirmOptions, useConfirm(), GroupDetail, GroupDetailPage(), GroupDetailPageProps, parseTab() (+15 more)
...
Cohesion: 0.19
Nodes (9): DashboardPage(), DashboardPageProps, User, useDocumentTitle(), LoginPage(), mockTrackEvent, SettingsPage(), SettingsPageProps (+1 more)

### Community 12 - "Group Card Component"
Cohesion: 0.17
Nodes (10): JoinedGroup, JoinGroupModal(), JoinGroupModalProps, Member, MembersTabProps, members, mockTrackEvent, buildApiUrl() (+2 more)
...
## Knowledge Gaps
- **190 isolated node(s):** `env`, `PackageJson`, `result`, `buf`, `encoded` (+185 more)
...
- **Why does `AppContext` connect `Bracket UI Components` to `API Routers & Auth Middleware`, `Auth Encoding & Google OAuth`, `Predictions Tab (legacy)`, `Bracket API Router`, `Button & Header (legacy)`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `signJwt()` connect `Bracket UI Components` to `Predictions Tab (legacy)`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `sendRoundReminders()` connect `Create Group Modal (legacy)` to `Bracket UI Components`, `Auth Encoding & Google OAuth`?**
